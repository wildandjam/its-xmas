<?php 
	...
	if (!$seoDone){	?>
		<title>Privacy Policy | It's Christmas</title>
	<?php
} ?>
</head>
...
<p>It's Christmas may collect and use Users personal information for the following purposes:<p>
<ul>
...
<p>It's Christmas has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site and send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
...
<p>admin@its-xmas.co.uk<br>
19 Stonebrook Way, B29 5XA<br>
<p>
<p><em>This document was last updated on August 14, 2014</em></p>

<p style="font-size:10px;color:gray;">Privacy policy created by <a style="font-size:10px;color:gray;text-decoration:none;cursor:default;" href="http://www.generateprivacypolicy.com" target="_blank">Generate Privacy Policy</a></p>
	</div>
