<?php 
	...
	if (isset($_REQUEST['email']) && isset($_REQUEST['password']) && isset($_REQUEST['rpassword']) && isset($_REQUEST['reset'])){
		...
		header("location: /reset-password/?status=technical&email=" . $email . "&resetcode=" . $reset);
	}
